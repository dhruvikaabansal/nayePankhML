...
<style>
  :root{
    ...
    --ink:#13302b; --muted:#5d726c; --line:#d8e2df; --bg:#f9fafb; --card:#ffffff;
  }
  *{box-sizing:border-box}
  ...
  /* header */
  header{background:#123c34;color:#fff;padding:30px 0 90px}
  .nav{display:flex;align-items:center;gap:12px}
  .logo{width:38px;height:38px;border-radius:4px;background:#fff;display:grid;place-items:center;color:var(--teal-d);font-weight:700;font-family:Poppins}
  ...
  .tagchip{display:inline-block;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.2);
           padding:4px 10px;border-radius:4px;font-size:12px;font-weight:500;margin-bottom:14px}
  .hero h1{font-size:32px;line-height:1.18;font-weight:700}
  .hero p{font-size:16px;opacity:.94;margin-top:12px}
  /* kpi cards */
  ...
  .kpi .v{font-family:Poppins;font-size:24px;font-weight:700;color:var(--teal-d)}
  .kpi .l{font-size:12px;color:var(--muted);margin-top:3px}
  /* sections */
  section{margin:46px 0}
  .eyebrow{color:var(--teal);font-weight:600;font-size:12px;letter-spacing:.08em;text-transform:uppercase}
  h2{font-size:22px;margin:6px 0 4px}
  ...
  .step{background:var(--card);border:1px solid var(--line);border-radius:6px;padding:18px}
  .step .n{width:28px;height:28px;border-radius:4px;background:var(--teal);color:#fff;display:grid;place-items:center;font-weight:700;font-family:Poppins;margin-bottom:10px}
  .step h3{font-size:15px} .step p{font-size:13px;color:var(--muted);margin:6px 0 0}
  /* controls */
  ...
  select{padding:8px 10px;border:1px solid var(--line);border-radius:4px;font-family:Inter;font-size:13px;background:#fff}
  .btn{background:var(--teal);color:#fff;border:0;padding:8px 14px;border-radius:4px;font-weight:600;cursor:pointer;font-family:Inter}
  /* table */
  ...
  .pill{display:inline-block;padding:1px 6px;border-radius:3px;font-size:11px;font-weight:600;color:#fff}
  ...
  .tablewrap{max-height:430px;overflow:auto;border:1px solid var(--line);border-radius:6px}
  ...
  .preset-btn{background:var(--card);border:1px solid var(--line);color:var(--muted);padding:6px 12px;border-radius:4px;font-weight:600;cursor:pointer;font-family:Inter;font-size:12px;transition:all .2s}
  ...
  .warning-box{background:#fff8f0;border-left:3px solid var(--amber);border-radius:0 4px 4px 0;padding:10px 14px;font-size:12.5px;margin-top:16px;color:#7a531e}
...
<div class="wrap">
  ...
  <section>
    ...
    <div class="card" style="margin-top: 24px; border-top: 4px solid var(--teal);">
      ...
      <div class="grid3" style="gap: 20px;">
        ...
        <div>
          <h4 style="font-size: 12.5px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--muted); margin: 0 0 12px;">State Need Rankings</h4>
          <div style="display: flex; flex-direction: column; gap: 8px;">
            ...
            <div>
              <strong style="color: var(--amber); font-size: 11px; display: block; text-transform: uppercase; letter-spacing: 0.02em; margin-bottom: 3px; margin-top: 2px;">Medium Need</strong>
  ...
  <section>
    ...
    <div class="grid3" style="margin-top:16px">
      ...
      <div class="card"><h3 style="font-size:15.5px;color:var(--teal-d)">Prioritize campaigns</h3>
