  ...
  <section>
    ...
    <div class="grid2" style="margin-bottom: 24px;">
      <div class="card" style="border-left: 4px solid var(--high);">
        <h3 style="font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--muted); margin-bottom: 8px;">🚨 Highest Need District</h3>
        <div style="display: flex; align-items: baseline; gap: 8px; margin: 4px 0;">
          <span id="recNeedName" style="font-size: 19px; font-weight: 700; font-family: Poppins;">-</span>
          <span class="pill High" id="recNeedTier">-</span>
        </div>
        <div style="font-size: 13px; margin: 4px 0 8px;">Need Index: <b id="recNeedIndex">-</b></div>
        <p class="note" id="recNeedReason" style="margin: 0; line-height: 1.45; font-size: 12.5px;">-</p>
      </div>
      <div class="card" style="border-left: 4px solid var(--amber);">
        <h3 style="font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--muted); margin-bottom: 8px;">🩸 Biggest Menstrual Hygiene Opportunity</h3>
        <div style="display: flex; align-items: baseline; gap: 8px; margin: 4px 0;">
          <span id="recGapName" style="font-size: 19px; font-weight: 700; font-family: Poppins;">-</span>
        </div>
        <div style="font-size: 13px; margin: 4px 0 8px;">Awareness Gap: <b id="recGapValue" style="color: var(--high);">-</b></div>
        <p class="note" id="recGapReason" style="margin: 0; line-height: 1.45; font-size: 12.5px;">-</p>
      </div>
    </div>
